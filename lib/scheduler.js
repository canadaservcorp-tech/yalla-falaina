...
const JOBS = [
  ...
  { name: 'promo-offer', everyMs: 24 * 60 * 60 * 1000, run: () => require('../scripts/promo-offer').run() },
  { name: 'bonus-expiry', everyMs: 24 * 60 * 60 * 1000, run: () => require('../scripts/bonus-expiry').run() },
];
