...
// cancel/resubscribe cycle (referral_credited already true). A failed grant
// rethrows on purpose: that fails the payment webhook, which is the only way
// PayPal/Stripe redeliver the event — answering 200 on a hiccup would lose the
// reward permanently, and re-processing the same event stays safe either way.
