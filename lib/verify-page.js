...
const T = {
  fr: {
    ...
    none: 'Aucune licence trouvée. Le registre ne contient que les licences en vigueur : si le numéro est bien écrit, il ne correspond à aucune licence valide aujourd’hui. Vérifiez au registre officiel avant de conclure.',
  ...
  en: {
    ...
    none: 'No licence found. The register only lists licences in force: if the number is spelled correctly, it matches no valid licence today. Check the official register before concluding.',
