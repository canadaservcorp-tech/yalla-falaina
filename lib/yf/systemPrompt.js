...
// retrieve-don't-recall shape as formatJobsForPrompt above.
function formatStudyForPrompt(opportunities) {
  ...
  return opportunities
    .map((o, i) => [
      ...
      `    tuition/funding: ${o.tuitionNote || o.eligibilityNote || 'not specified'}`,
      `    deadline: ${o.deadline || 'rolling / not specified'}`,
      `    requirements: ${o.requirements || 'not specified'}`,
