...
select * from (values
  ...
  ('scholarship', 'Turkiye Scholarships (Turkiye Burslari) -- Fully-Funded Government Scholarship',
   ...
   100,
   'Published monthly stipend: TRY 4,500 (associate/bachelor''s), TRY 6,500 (master''s), TRY 9,000 (PhD) -- doubled for merit-scholarship recipients. Dormitory housing is provided in full for undergraduates; for graduate/PhD students it is provided in year one only, then a housing allowance of TRY 6,000/month (Istanbul/Ankara) or TRY 5,000/month (elsewhere) applies. Figures are government-published and subject to annual revision -- confirm at application time.',
   null::date,
  ...
  ('program', 'Bachelor''s & Master''s Programs (Engineering, Business, Pharmacy)',
   ...
   'English', null,
   'Published AY2025-2026 per-credit-hour tuition (USD): Engineering/Architecture USD 935; Business USD 911; Science & Liberal Arts USD 859; Education/English/Psychology/Political Science USD 770; Pharmacy USD 999; Design USD 942; Nursing (new students) USD 659.',
   null,
